    ...
    <div class="home-page-container ng-scope" ng-controller="HomeCtrl"> 
     <div class="row login-register-row"> 
      <div class="col-xs-8 banner-part"> 
       ...
       <div class="banner-img" style="margin-top:3%; position:absolute;"> 
        <img src="uploads/l1.jpg" alt="" style="width:100%;height:100%;position:absolute;" id="l1">
        <img src="uploads/l2.jpg" alt="" style="width:100%;height:100%;position:absolute;display:none;" id="l2">
       </div>
      </div> 
      <script>
          var nowimg=1;
      ...
      <div class="col-xs-4 register-tab login-shown"> 
       ...
       <div class="login-content text-center"> 
        <div class="user-info">
         尊敬的：
         <span><?php if(isset($userinfo)){echo $userinfo['uname'];}else{echo "游客";}?></span>
        </div> 
        <div class="wel-info">
         欢迎回来!
        </div> 
        ...
        <div class="number-cash"><?php if(isset($userinfo)){echo $userinfo['all_gold'];}else{echo "100.00";}?>元</div> 
        <div> 
         <a class="btn btn-primary recharge" href="<?=Url::toRoute('user/pay');?>">充值</a>
        </div> 
        <div> 
         <a class="btn btn-primary account-info" href="<?=Url::toRoute('user/info');?>">我的账户</a>
        </div> 
       </div> 
      </div> 
...
<h3>
<a class="ng-binding" ng-bind="post.title" href="javascript:;">银行和P2P平台首次“结盟”：苏州银行和点融网宣布...</a>
</h3>
</div>
...
<h3>
<a class="ng-binding" ng-bind="post.title" href="javascript:;">郭宇航：P2P———技术与商业模式的新浪潮</a>
</h3>
</div>
<div class="news-img pull-right">
...
<h3>
<a class="ng-binding" ng-bind="post.title" href="javascript:;">"红筹之父"梁伯韬先生加入点融网董事会</a>
</h3>
</div>
<div class="news-img pull-right">
     ...
     <div class="row about-us-row"> 
      ...
      <div class="col-xs-4 third"> 
       <div class="dr-info help-center"> 
        ...
        <div class="faq">
         <a href="javascript:;"><span class="sl-icon-bold-column icon"></span><span class="question">什么是点融网</span></a>
        </div> 
        <div class="faq">
         <a href="javascript:;"><span class="sl-icon-bold-right-arrow icon"></span><span class="question">为什么选择点融网</span></a>
        </div> 
        <div class="faq">
         <a href="javascript:;"><span class="sl-icon-bold-spark icon"></span><span class="question">点融网投资流程</span></a>
        </div> 
        <div class="faq">
         <a href="javascript:;"><span class="sl-icon-bold-pen icon"></span><span class="question">使用及操作</span></a>
        </div> 
        <div class="faq">
         <a href="javascript:;"><span class="sl-icon-bold-lock icon"></span><span class="question">信息和资金安全</span></a>
        </div> 
        <div class="faq">
         <a href="javascript:;"><span class="sl-icon-bold-paper icon"></span><span class="question">政策法规</span></a>
        </div> 
        <div class="faq">
         <a href="javascript:;"><span class="sl-icon-bold-star icon"></span><span class="question">常见问题</span></a>
        </div> 
        <div class="text-right more-detail">
         <a href="javascript:;">更多&gt;</a>
        </div> 
