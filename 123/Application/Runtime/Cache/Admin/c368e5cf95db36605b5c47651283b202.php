...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li class="click"><span><img src="/xianshang/Public/Admin/images/t01.png" /></span><a href="<?php echo U('power_add');?>">添加</a></li>
        </ul>
    </div>
    ...
    <table class="tablelist">
        ...
        <tbody>
        <?php if(is_array($power)): foreach($power as $key=>$vo): ?><tr class="tr" id="0_1" power_id="<?php echo ($vo["power_id"]); ?>" power_pid="<?php echo ($vo["power_pid"]); ?>">
            <td width="3%"><span class="span">[+]</span></td>
            <td width="7%"><?php echo ($vo["power_id"]); ?></td>
            <td><?php echo ($vo["power_name"]); ?></td>
            <!--<td>王金平幕僚：马英九声明字字见血 人活着没意思</td>-->
            <td><?php echo ($vo["power_controller"]); ?></td>
            <td><?php echo ($vo["power_action"]); ?></td>
            <td><a href="<?php echo U('Power/power_update');?>?power_id=<?php echo ($vo["power_id"]); ?>" class="tablelink">修改</a>
                <a href="<?php echo U('Power/power_delete');?>?power_id=<?php echo ($vo["power_id"]); ?>" class="tablelink"> 删除</a></td>
