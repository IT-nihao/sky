...
<div class="formbody">
    ...
    <form action="<?php echo U('users/users_add');?>" method="post">
        <ul class="forminfo">
            <li><label>管理员账号</label><input name="user_account" type="text" class="dfinput" /></li>
            <li><label>管理员密码</label><input name="user_pwd" type="text" class="dfinput" /></li>
            <li><label>用户角色</label>
                <cite>
                    <table>
