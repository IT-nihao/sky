...
<ul class="forminfo">
    ...
    <li><label>经营范围</label><input name="address_scope" type="text" class="dfinput" /><i>格式(500/1000)单位：米</i></li>
        ...
        $.ajax({
            ...
            success:function(r){
                ...
                $.each(r,function(k,v){
                    ...
                    var circle = new BMap.Circle(point,v.address_scope,{strokeColor:"#8B0000", strokeWeight:2, strokeOpacity:0.5}); //创建圆
                    //添加覆盖物
