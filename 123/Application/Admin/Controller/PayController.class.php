...
class PayController extends CommonController {
    ...
    public function pay_login(){
        ...
        if($arr){
//          $is_user = M("yixue_user_role")->where("yixue_user_id = $arr[user_id] and yixue_role_id = 28")->find();
//            if($arr['user_id'] == 1){
//                $this->success("登陆成功",U('pay_partner_list'));
//            }else{
...
//    public function pay_partner_list(){
...
//        $data = partner("yixue_partner","$search_account",$search_home,$search_code,$partner_tel,"user_id,user_account,user_pwd,finance_pwd,partner_account,partner_idcard,partner_sex,partner_tel,partner_home,partner_time,partner_government,partner_government,partner_money,partner_code,detailed_address","user_id",$dakehu_ids);
////        print_r($data);die;
...
//            echo $user_id;die;
    ...
    public function pay_my(){
        $session =session("yixue_user");
        $id = $session['user_id'];
//        $end_time =  I("get.end_time","1970-01-01");
//        $start_time =  I("get.start_time","2099-01-01");
//        echo $end_time;die;
...
//            $where['pay_time'] = array('between', "$str_start,$str_end");
