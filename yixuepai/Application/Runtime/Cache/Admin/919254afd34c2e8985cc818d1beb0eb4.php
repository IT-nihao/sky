...
<body>
    ...
    <ul class="forminfo">
    <li><label>权限名称</label><input name="power_name" type="text" class="dfinput" /><i>标题不能超过30个字符</i></li>
    <li><label>控制器名称</label><input name="power_controller" type="text" class="dfinput" /><i>多个关键字用,隔开</i></li>
    <li><label>方法名称</label><input name="power_action" type="text" class="dfinput" /><i>多个关键字用,隔开</i></li>
