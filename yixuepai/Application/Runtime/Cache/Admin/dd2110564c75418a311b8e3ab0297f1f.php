...
<body style="background-color:#1c77ac; background-image:url(/xianshang/Public/Admin/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
    ...
    <span class="systemlogo"></span>
        <form action="<?php echo U('Pay/pay_login');?>" method="post">
    <div class="loginbox">

    <ul>
        <li><input name="user_account" type="text" class="loginuser" value="" onclick=""/></li>
        <li><input name="finance_pwd" type="text" class="loginpwd" value="" onclick=""/></li>
    <li><input name="" type="submit" class="loginbtn" value="登录"  onclick=""  /><label><input name="rem" type="checkbox" value="1" checked="checked" />记住密码</label><label><a href="#">忘记密码？</a></label></li>
    </ul>
    </div>
    </form>
    </div>
