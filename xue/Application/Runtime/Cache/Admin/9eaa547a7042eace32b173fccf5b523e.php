       ...
       <div id="ddd">
           <center><div class="biaoti">阅读星级：<?php echo ($arr["read_difficulty_id"]); ?>星&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <?php if(is_array($crr)): foreach($crr as $k=>$vv): ?><div class="xuan">
                    <?php if($arr['read_type_id'] == 1): ?><div class="xuanxiang">标题<?php echo ($k+1); echo ($vv["topic_timu"]); ?></div>
                    <?php else: ?>
                    <div class="xuanxiang">标题:<?php echo ($vv["topic_timu"]); ?></div><?php endif; ?><div class="xuanxiang">A、<?php echo ($vv['daan'][0]['topic_text']); ?>；</div ><div class="xuanxiang">B、<?php echo ($vv['daan'][1]['topic_text']); ?>；</div><div class="xuanxiang">C、<?php echo ($vv['daan'][2]['topic_text']); ?>；</div><div class="xuanxiang">D、<?php echo ($vv['daan'][3]['topic_text']); ?></div></div><?php endforeach; endif; ?><li>
