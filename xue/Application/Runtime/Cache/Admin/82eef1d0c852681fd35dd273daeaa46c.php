...
<div class="rightinfo">
    ...
    <table class="tablelist" style="table-layout: fixed">
        ...
        <?php if(is_array($arr)): foreach($arr as $key=>$vo): ?><tr class="tr" id="0_1" user_id="<?php echo ($vo["user_id"]); ?>" style="">
                ...
                <td><a href="<?php echo U('Print/print_add');?>?read_level_id=<?php echo ($vo["print_level"]); ?>&read_type_id=<?php echo ($vo["print_type"]); ?>&students_id=<?php echo ($vo["print_students_id"]); ?>&read_textbook_id=<?php echo ($vo["print_textbook"]); ?>" class="tablelink"> 打印</a>
                    <a href="<?php echo U('Print/print_word');?>">单词</a>
                </td>
