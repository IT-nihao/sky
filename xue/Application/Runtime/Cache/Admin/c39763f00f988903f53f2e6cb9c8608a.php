...
<div class="formbody">
    ...
    <form action="<?php echo U('Read/read_add');?>" method="post">
        <ul class="forminfo">
            <input type="text" value="<?php echo ($students_id); ?>" name="students_id">
            <li><label>文章内容</label>
            ...
            <li><label>文章关卡</label>
                <select name="read_level_id" class="dfinput textbook_id">
                    <option value="0">请选择文章关卡</option>
                    ...
                    <option value="7">第七关</option>
                    <option value="8">第八关</option>
                    <option value="9">第九关</option>
                    <option value="10">第十关</option>
                </select>
            </li>
            <li><label>文章难度</label>
