...
<div class="rightinfo">
    <div class="tools">
        <!--<ul class="toolbar">-->
            <!--<li class="click"><span><img src="/xianshang/Public/Admin/images/t01.png" /></span></li>-->
        <!--</ul>-->
        <form action="<?php echo U('Read/read_list');?>" method="get">
    ...
    <table class="tablelist" style="table-layout: fixed">
        ...
        <?php if(is_array($arr)): foreach($arr as $key=>$vo): ?><tr class="tr" id="0_1" user_id="<?php echo ($vo["user_id"]); ?>" style="">
                ...
                <td><a href="<?php echo U('Read/read_look');?>?read_level_id=<?php echo ($vo["read_level_id"]); ?>&read_type_id=<?php echo ($vo["read_type_id"]); ?>" class="tablelink"> 查看</a>
                    <a href="<?php echo U('Read/read_update');?>?read_level_id=<?php echo ($vo["read_level_id"]); ?>&read_type_id=<?php echo ($vo["read_type_id"]); ?>" class="tablelink">修改</a>
                    <a href="<?php echo U('Read/read_delete');?>?read_level_id=<?php echo ($vo["read_level_id"]); ?>&read_type_id=<?php echo ($vo["read_type_id"]); ?>" class="tablelink"> 删除</a>
                </td>
