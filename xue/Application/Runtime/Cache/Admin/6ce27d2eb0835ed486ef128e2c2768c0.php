...
<div class="rightinfo">
    <div class="tools">
        ...
        <ul class="toolbar">
            <li class="click"><span><img src="/xianshang/Public/Admin/images/t01.png" /></span><a href="<?php echo U('users_add');?>">添加</a></li>
        </ul>
    </div>
    ...
    <table class="tablelist">
        ...
        <tbody>
        <?php if(is_array($show)): foreach($show as $key=>$vo): ?><tr class="tr" id="0_1" user_id="<?php echo ($vo["user_id"]); ?>">
                <td width="7%"><?php echo ($vo["user_id"]); ?></td>
                <td><?php echo ($vo["user_account"]); ?></td>
                <td><?php echo ($vo["role_name"]); ?></td>
                <td><a href="<?php echo U('users/users_update');?>?user_id=<?php echo ($vo["user_id"]); ?>" class="tablelink">修改</a>
                    <a href="<?php echo U('users/users_delete');?>?user_id=<?php echo ($vo["user_id"]); ?>" class="tablelink"> 删除</a></td>
